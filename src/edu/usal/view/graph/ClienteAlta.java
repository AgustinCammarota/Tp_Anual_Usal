...
public class ClienteAlta extends JFrame {
	...
	public ClienteAlta(MenuClienteController mcc) {
		this.mcc = mcc;
		...
		comboBoxPais.addItemListener(new MenuAltaClientesEventos(this));
		...
		btnGuardarCliente.addActionListener(new MenuAltaClientesEventos(this));
		
		btnCancelar = new JButton("Cancelar");
		btnCancelar.addActionListener(new MenuAltaClientesEventos(this));
